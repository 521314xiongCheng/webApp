...
<template>
  ...
  >
    <span class="el-dropdown-link"> 筛选 </span>
    <el-dropdown-menu slot="dropdown">
      <div class="filter-content">
        ...
        <div class="filter-button">
          ...
          <span class="filter-button-confirm" @click="filterConfirm">
            <el-dropdown-item command="filterConfirm">确认 </el-dropdown-item>
          </span>
        </div>
      </div>
    </el-dropdown-menu>
...
export default {
  ...
  methods: {
    ...
    selectItem(item, filter) {
      ...
      let eventType = "RetailDetailFilterTagClick";
      if (this.pageName === "PersonalProfilePage") {
        eventType = "PersonalRetailDetailFilterTagClick";
      }
      this.$track({
    ...
    filterReset() {
      ...
      let eventType = "RetailDetailFilterCancelClick";
      if (this.pageName === "PersonalProfilePage") {
        eventType = "PersonalFilterResetClick";
      }
      this.$track({
        context: this.pageName,
        behavior: eventType,
