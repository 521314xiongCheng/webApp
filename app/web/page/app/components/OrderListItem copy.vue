    ...
    <div class="order-info">
          ...
          <img
            ...
            :src="
              orderData.headImageUrl
                ? orderData.headImageUrl
                : `https://xxxxxxxx/20210510150439_466_@_thumb_60.jpg`
            "
            alt=""
          />
          <div>
              ...
              {{
                new Date(
                  `${orderData.orderDate
                    ...
                    .split("-")
                    .join("/")} ${
                    orderData.orderDate.split("T")[1].split(".")[0]
                  }`
      ...
      <div class="discount-desc">
        <div
          ...
          class="flex-align-center"
        >
          订单金额: {{ orderData.realRetail }}*折扣{{
            parseInt(orderData.discountRate * 10) * 10
          }}%
        </div>
              ...
              <div class="product-image">
                <img
                  :src="
                    item.imageUrl
                      ? item.imageUrl
                      : 'https://xxxxxxxx/20220106140017_630.png'
                  "
                  alt=""
                />
              </div>
