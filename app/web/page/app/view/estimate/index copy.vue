  ...
  <div class="coach-home" :class="{ 'isAndroid': !isIos }">
    ...
    <div class="coach-home-content">
      <div class="title">
        ...
        <span
          >当前收益都是基于本人A状态下收益预估,实际收益请以实际收入为准,请知晓。</span
        >
      </div>
      <!-- 零售 -->
      <div class="retail">
        ...
        <div class="retail-sub">
          <div>
            <span>绩效:</span>
            <span class="retail-sub-num" style="color: #181818">{{getIncomedata.retail.productionAmt |formatMoney}}</span>
          </div>
          <div>
            <span>收入:</span>
            <span class="retail-sub-num" style="color: #f16eae">¥{{getIncomedata.retail.incomeAmt |formatMoney}}</span>
          </div>
        </div>
      ...
      <div class="retail">
        ...
        <div class="retail-sub">
          <div>
            <span>绩效:</span>
            <span class="retail-sub-num" style="color: #181818">{{getIncomedata.team.productionAmt |formatMoney}}</span>
          </div>
          <div>
            <span>收入:</span>
            <span class="retail-sub-num" style="color: #f16eae">¥{{getIncomedata.team.incomeAmt |formatMoney}}</span>
          </div>
        </div>
      ...
      <div class="retail no-border" v-if="this.levelCode>=60" >
        ...
        <div class="retail-sub">
          <div>
            <span>绩效:</span>
            <span class="retail-sub-num" style="color: #181818">{{getIncomedata.unit.productionAmt |formatMoney}}</span>
          </div>
          <div>
            <span>收入:</span>
            <span class="retail-sub-num" style="color: #f16eae">¥{{getIncomedata.unit.incomeAmt |formatMoney}}</span>
          </div>
        </div>
      ...
      <div class="retail retail-area" v-if="this.levelCode>=70">
        ...
        <div class="retail-sub">
          <div>
            <span>月平均:</span>
            <span class="retail-sub-num" style="color: #181818">{{getIncomedata.area.productionAmt |formatMoney}}</span>
          </div>
          <div>
            <span>收入:</span>
            <span class="retail-sub-num" style="color: #f16eae">¥{{getIncomedata.area.incomeAmt |formatMoney}}</span>
          </div>
        </div>
         <div class="retail-mes">
           注：管理区域收入基于过去三个月一类沙龙绩效和平均值乘以收入系数计算所得
         </div>
      </div>
