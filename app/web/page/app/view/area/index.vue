                ...
                <div class="user">
                  <div class="user-info">
                    ...
                    <div
                      class="tags"
                      v-if="
                        targetContactId === row.directorContactId.toString()
                      "
                    >
                      <span class="level">{{
                        row.directorCareerLevelCode
                      }}</span>
                      <span class="status">{{
                        row.directorActivityStatusCode
                      }}</span>
                      <span class="self">本人</span>
                    </div>
                    <div class="no-self" v-else>
      ...
      switch (item.prop) {
        ...
        case "profile": //个人详情
          ...
          const params = {
            ...
            targetContactId:
              this.sheetType == "director"
                ? this.currentData.directorContactId
                : this.currentData.contactId,
            levelCode:
              this.sheetType == "director"
                ? this.currentData.directorCareerLevelCode
                : this.currentData.careerLevelCode,
            //跟进人
        ...
        case "call": //拨打电话
          window.location.href =
            this.sheetType == "director"
              ? `tel:${this.currentData.directorMobile}`
              : `tel:${this.currentData.mobile}`;
          break;
      }
