...
export default {
  ...
  data() {
    return {
      ...
      pageName: "HomePage",
      landscapeEventName: "UnitHistoryLandscapeClick",
      export2ExcelEventName: "UnitHistoryExcelExportClick",
    };
  },
  created() {
    this.loadData();
    ...
    if (from === "UnitDetailsPage") {
      this.pageName = "UnitDetailsPage";
      this.landscapeEventName = "HistoryProdLandscapeClick";
      this.export2ExcelEventName = "HistoryProdExcelExportClick";
    } else {
      this.pageName = "HomePage";
      this.landscapeEventName = "UnitHistoryLandscapeClick";
      this.export2ExcelEventName = "UnitHistoryExcelExportClick";
    }
  },
  methods: {
    back() {
