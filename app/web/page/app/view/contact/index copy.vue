<template>
  <div class="search-wrap" :class="{ isIphoneX: isIphoneX, isAndroid: !isIos }">
    <div class="search-bar">
      ...
      >
        <template #left-icon>
          <img class="icon-input-search" src="../../images/icon_input_search.png" alt="">
        </template>
      </van-search>
    </div>
    <div style="width: 100%; height: 10px; background-color: #f5f5f5"></div>
    <!--  -->
    <van-collapse v-model="activeNames" v-if="isData">
