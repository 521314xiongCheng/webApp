...
export default {
  ...
  created() {
    const { monthKey, targetContactId } = this.$route.query;
  ...
  methods: {
    ...
    handleClick() {
      this.$track({
        ...
        behavior: "OffspringDetailsTextSearchClick",
        item_type: "StaffOffspringDetasilsPage",
        item_id: "OffspringDetailsTextSearchClick",
      });
    },
    onCancel() {
      this.$track({
        context: "StaffOffspringDetasilsPage",
        behavior: "OffspringDetailsCancelSearchClick",
        item_type: "StaffOffspringDetasilsPage",
        item_id: "OffspringDetailsCancelSearchClick",
      });
      closeWebview();
    },
    onSearch(keywords) {
    ...
    async loadData() {
      ...
      this.loading = true;
      const { pageNo, pageSize, keywords, sortEnum, orderEnum } = this.filter;
      const params = {
        pageNo,
        pageSize,
        keywords,
